...
def test_multimodal():
    print("=== MULTIMODAL AI TEST: 3 SCENARIOS ===")
    ...
    for sc in scenarios:
        print(f"\n==========================================")
        print(f"[{sc['name']}]")
        print(f"   Inputs: Pain={sc['pain']}, Stiffness={sc['stiff']}m, Swelling={sc['swell']}, Injury={sc['inj']}")
        ...
        print(f"        Result: {tflite_pred.upper()} (Probabilities: {tflite_probs})")
