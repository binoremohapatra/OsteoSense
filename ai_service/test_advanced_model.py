...
--------------------
Test the advanced model with uncertainty estimation.
"""
...
print("=" * 80)
print("TESTING ADVANCED MODEL WITH UNCERTAINTY")
print("=" * 80)
print()
...
if len(borderline) > 0 and len(meaningful_uncertainty) > 0:
    print("SUCCESS: Model shows reasonable uncertainty and borderline cases!")
    print("This is much better than the previous overconfident model.")
elif len(meaningful_uncertainty) > 0:
    print("PROGRESS: Model shows some uncertainty, but needs more work.")
else:
    print("ISSUE: Model still too confident - needs further improvement.")
